 ...
 ******************************************************************************/
package com.nouveauxterritoires.eterritoires.identityserver.openid.connect.client;
...
public class OIDCAuthenticationProvider implements AuthenticationProvider {
	...
	private TaxeUserInfoFetcher taxeUserInfoFetcher = new TaxeUserInfoFetcher();
	...
	public Authentication authenticate(final Authentication authentication)
		...
		if (authentication instanceof OIDCAuthenticationToken) {
			...
			UserInfo userInfo = taxeUserInfoFetcher.loadUserInfo(token);
