 ...
 ******************************************************************************/
package com.nouveauxterritoires.eterritoires.identityserver.openid.connect.model;
...
@Entity
@Table(name="taxe_user_info")
@NamedQueries({
	@NamedQuery(name="TaxeUserInfo.getAll", query = "select u from TaxeUserInfo u"),
	@NamedQuery(name="TaxeUserInfo.getByUsername", query = "select u from TaxeUserInfo u WHERE u.preferredUsername = :username"),
	@NamedQuery(name="TaxeUserInfo.getBySubject", query = "select u from TaxeUserInfo u WHERE u.sub = :sub"),
	@NamedQuery(name="TaxeUserInfo.getById", query = "select u from TaxeUserInfo u WHERE u.id = :id")
})
public class TaxeUserInfo implements UserInfo {
	...
	private Date createdAt; // time the user was created
	...
	public static UserInfo fromJson(JsonObject obj) {
		TaxeUserInfo ui = new TaxeUserInfo();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof TaxeUserInfo)) {
			return false;
		}
		TaxeUserInfo other = (TaxeUserInfo) obj;
		if (address == null) {
