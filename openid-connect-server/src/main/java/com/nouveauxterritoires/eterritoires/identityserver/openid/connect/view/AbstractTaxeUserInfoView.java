 ...
 * 
 */
package com.nouveauxterritoires.eterritoires.identityserver.openid.connect.view;
...
/**
 * 
 * Abstract superclass for client entity view, used with the TaxeUserInfoApi.
 * 
 ...
 *
 */
public abstract class AbstractTaxeUserInfoView extends AbstractView {
	private static Logger logger = LoggerFactory.getLogger(AbstractTaxeUserInfoView.class);
